...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__node_modules_d3__ = __webpack_require__(170);
  ...
  const bisectYear = __WEBPACK_IMPORTED_MODULE_0__node_modules_d3__["c" /* bisector */]( d => { return d.Year; }).left;

  // Scales

  const x = __WEBPACK_IMPORTED_MODULE_0__node_modules_d3__["i" /* scaleLinear */]()
    .range([0, width]);


  const y = __WEBPACK_IMPORTED_MODULE_0__node_modules_d3__["i" /* scaleLinear */]()
    .range([height, 0]);

  // Create Axes

  const xAxis = __WEBPACK_IMPORTED_MODULE_0__node_modules_d3__["a" /* axisBottom */]()
    .scale(x)
    .tickFormat(__WEBPACK_IMPORTED_MODULE_0__node_modules_d3__["f" /* format */]("d"));
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_1_d3_array__["c"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "h", function() { return __WEBPACK_IMPORTED_MODULE_23_d3_selection__["d"]; });
